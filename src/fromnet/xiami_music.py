...
class XiamiDownload(object):
    ...
    def __get_xml(self):
        ...
        return 'http://www.xiami.com/song/playlist/id/%s/object_name/default/object_id/0' % re.search(
            '\d+', self.url_song).group()
...
if __name__ == '__main__':
    ...
    pattern = re.compile(
        '<embed.*?src="http://www.xiami.com/widget/0_(.*?)/multiPlayer.swf"',
        re.S)
